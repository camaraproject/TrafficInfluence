...
Checklist for traffic-influence in v0.9.0-rc.1 in r.1.2
...
|  4 | API versioning convention applied            |   M   |         M         |    M    |    M   |   Y  | v0.9.0-rc.1 |
...
| 13 | API description (for marketing)              |   O   |         O         |    M    |    M   |   N  | [wiki link](https://lf-camaraproject.atlassian.net/wiki/x/d4JlBQ) |
